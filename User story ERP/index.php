        ...
        <div class="form-box">
            <div class="form-value">
                <form action="index.php" method="post">
                    <a href="https://www.gildeopleidingen.nl"><ion-icon name="arrow-back-outline"
                            class="arrow"></ion-icon></a>
                    <a href="index.php?lang=nl"><img src="img/NL.png" alt="NL Flag" class="flag-nl"
                            href="nl-index.html"></a>
                    ...
                    <div class="forget">
                        <label for=""><a href="password.php">
                                <?php echo $lang['pforgot'] ?>
                            </a></label>
